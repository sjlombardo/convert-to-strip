...
perlapp --trim JSON::PP58 --norunlib --gui --nologo --target windows-x86-32 --info "CompanyName=Zetetic LLC;FileVersion=1.0.6;InternalName=convert-to-codebook;LegalCopyright=Copyright 2012-2016 Zetetic LLC All rights reserved;OriginalFilename=convert-to-codebook;ProductName=Convert to Codebook;ProductVersion=1.0.6" --exe %EXE% convert-to-codebook.pl
